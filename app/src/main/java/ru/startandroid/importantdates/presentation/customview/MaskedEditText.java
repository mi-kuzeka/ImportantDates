...
//		if (text == null || text.equals("")) return;
    ...
    private void generatePositionArrays() {
        try {
            ...
            Log.e(TAG, "Error in GeneratePositionArrays");
        }
    }
    ...
    public void beforeTextChanged(CharSequence s, int start, int count,
        ...
        try {
            ...
            Log.e(TAG, "Error in beforeTextChanged");
        }
    }
    ...
    private int erasingStart(int start) {
        try {
            ...
            Log.e(TAG, "Error in erasingStart");
        }
        return start;
    }
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        try {
            ...
            Log.e(TAG, "Error in onTextChanged");
        }
    }
    ...
    public void afterTextChanged(Editable s) {
        try {
            ...
            Log.e(TAG, "Error in afterTextChanged");
        }
    }
    ...
    protected void onSelectionChanged(int selStart, int selEnd) {
        ...
        try {
            ...
            Log.e(TAG, "Error in onSelectionChanged");
        }
    }
    ...
    private String clear(String string) {
        try {
            ...
            Log.e(TAG, "Error in clear method");
        }
        return string;
    }
}
